...
\begin{tabular}{|c|c|}
    \hline
    \includegraphics[width=.6\textwidth] {Images/42.1.png} & \includegraphics[width=.6\textwidth]{Images/42.2.png}\\
    \hline
\end{tabular}
...
\begin{center}
    \includegraphics[width=.6\textwidth]{Images/45.png}
...
\begin{center}
    \includegraphics[width=.6\textwidth]{Images/48.png}
...
\begin{center}
    \includegraphics[width=.8\textwidth]{Images/50.png}
...
\begin{tabular}{|l|c|r|}
    \hline
    \includegraphics{Images/54.png} &  \includegraphics{Images/55.png}\\
    \hline
...
\begin{tabular}{|l|c|r|}
    \hline
    \includegraphics{Images/56.png} &  \includegraphics{Images/57.png}\\
    \hline
...
\begin{tabular}{|l|c|r|}
    \hline
    \includegraphics[width=.6\textwidth]{Images/58.png} &  \includegraphics[width=.6\textwidth]{Images/59.png}\\
    \hline
...
\begin{tabular}{|l|c|r|}
    \hline
    \includegraphics[width=.6\textwidth]{Images/60.png} &  \includegraphics[width=.6\textwidth]{Images/61.png}\\
    \hline
...
\begin{tabular}{|l|c|r|}
    \hline
    \includegraphics[width=.6\textwidth]{Images/63.png} &  \includegraphics[width=.6\textwidth]{Images/64.png}\\
    \hline
